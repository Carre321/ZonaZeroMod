...
/**
 * /kit gui [player]
 * - Jugador: abre su menú
 * - Consola: requiere [player]
 * - Abrir para otro jugador como jugador requiere kit.admin
 */
public class KitGuiCommand extends AbstractKitTargetCommand {

    public KitGuiCommand() {
        super("gui", "Abre el menú (GUI) de kits");
